								...
								<div class="recent-post-widget">
                                    ...
                                    <div class="ori-recent-post-item d-flex align-items-center">
										...
										<div class="recent-blog-text">
											...
											<h3><a href="<?php echo get_the_permalink($firstRelatedPost); ?>"><?php echo get_the_title($firstRelatedPost); ?></a></h3>
										</div>
									</div>
                                        <?php endif; ?>
                                    ...
                                    <?php
                                        $secondRelatedPost = get_field('second_related_post');
                                    ...
                                    <div class="ori-recent-post-item d-flex align-items-center">
										...
										<div class="recent-blog-text">
											...
											<h3><a href="<?php echo get_the_permalink($secondRelatedPost); ?>"><?php echo get_the_title($secondRelatedPost); ?></a></h3>
										</div>
									</div>
                                        <?php endif; ?>
                                    <!-- Third related post end -->
                                    <?php
                                        $thirdRelatedPost = get_field('third_related_post');
                                        if( $thirdRelatedPost ): 
                                    ...
                                    <div class="ori-recent-post-item d-flex align-items-center">
										...
										<div class="recent-blog-text">
											...
											<h3><a href="<?php echo get_the_permalink($thirdRelatedPost); ?>"><?php echo get_the_title($thirdRelatedPost); ?></a></h3>
										</div>
									</div>
                                        <?php endif; ?>
                                    <!-- Third related post end -->
